        ...
        <div className="flex items-center justify-between gap-3 py-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <Dialog>
              ...
              <DialogContent
                className="
                  max-w-md rounded-2xl border border-sky-100/80 bg-slate-50/95 p-5 shadow-xl
                  dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100
                "
              >
                <DialogHeader className="mb-3 space-y-2">
                  <DialogTitle className="text-base font-semibold text-sky-900 dark:text-sky-100">
                  ...
                  <ol className="space-y-3">
                    <li className="flex gap-2">
                      ...
                      <p className="text-slate-700 dark:text-slate-100">
                        In <span className="font-semibold">Pokémon TCG Live</span>, open the game log
                        and copy the full text export.
                      </p>
                    </li>
                    <li className="flex gap-2">
                      <span className="mt-0.5 inline-flex h-5 w-5 items-center justify-center rounded-full bg-sky-100 text-[11px] font-semibold text-sky-800 dark:bg-sky-900/70 dark:text-sky-100">
                      ...
                      <p className="text-slate-700 dark:text-slate-100">
                        With the desktop helper running, Dragapultist will detect the copied log
                        automatically, or you can paste it into the box and click{" "}
                    ...
                    <li className="flex gap-2">
                      ...
                      <p className="text-slate-700 dark:text-slate-100">
                        The app parses the log into a summary: main attackers, prize counts, damage,
                        turns, and win/loss.
                      </p>
                    </li>
                    <li className="flex gap-2">
                      ...
                      <p className="text-slate-700 dark:text-slate-100">
                        Use the table to search and sort your games. Future updates will add deck-based
                        stats and matchup breakdowns.
                      </p>
                    </li>
                  </ol>

                  <p className="pt-2 text-[11px] leading-snug text-slate-500 dark:text-slate-400">
                    Dragapultist is an unofficial fan-made tool and is not affiliated with or endorsed
                    by The Pokémon Company, Creatures Inc., GAME FREAK Inc., or Pokémon TCG Live.
                  </p>
                </div>
              </DialogContent>
            </Dialog>
